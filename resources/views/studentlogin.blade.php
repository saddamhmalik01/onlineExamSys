    ...
    <body>
        <nav class="navbar navbar-light bg-info">
            <div class="container-fluid">
              ...
              <span> <a style="text-decoration: none; color:white" href="/" ><b>Staff Login</b> </a>
        ...
        <form style='margin-left:100px' action="stulogin" method="POST">
            <br><br>
            <h2 class="h2">Student Login</h2><br><br><br>
            @csrf
